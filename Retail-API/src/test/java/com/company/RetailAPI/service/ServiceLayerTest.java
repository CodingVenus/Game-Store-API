...
public class ServiceLayerTest {
    ...
    public void findLevelUpByCustomerId() {
        ...
        customer.setFirstName("Venus");
        customer.setLastName("Teah");
        customer.setStreet("161 Broad St.");
        customer.setCity("Jersey City");
        customer.setZip("07100");
        customer.setPhone("300-430-2000");
        customer.setEmail("Venus@elmalah.com");
    ...
    public void findInvoice() {
        ...
        customer.setZip("07100");
        customer.setPhone("300-430-2000");
        customer.setEmail("Venus@gmail.com");
        //// invoice items
    ...
    private void setUpCustomerClientMock(){
        ...
        output.setFirstName("Venus");
        output.setLastName("Teah");
        output.setStreet("161 Broad St.");
        output.setCity("Jersey City");
        output.setZip("07100");
        output.setPhone("300-430-2000");
        output.setEmail("Venus@gmail.com");
