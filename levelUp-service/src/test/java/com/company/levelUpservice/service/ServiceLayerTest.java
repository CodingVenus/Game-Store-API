...
public class ServiceLayerTest {
    ...
    public void saveLevelUp() {
        ...
        input.setMemberDate(LocalDate.of(2019,12,12));
        input.setPoints(25);
    ...
    public void findLevelUp() {
        ...
        expectedOutput.setMemberDate(LocalDate.of(2019,12,12));
    ...
    public void updateLevelUp() {
        ...
        fakeLevelUp.setMemberDate(LocalDate.of(2019,12,12));
    ...
    private void setUpLevelUpDaoMock() {
        ...
        output.setMemberDate(LocalDate.of(2019,12,12));
        output.setPoints(25);
